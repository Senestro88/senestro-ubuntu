...
login() {
    ...
    # --bind /sdcard:/sdcard                            : share Android storage inside Ubuntu
    ...
    echo "proot-distro login --user $user ubuntu --bind /dev/null:/proc/sys/kernel/cap_last_last --shared-tmp --bind /sdcard:/sdcard $FIXPORTS_FLAG" \
