#!/bin/bash
# =============================================================================
# senestro-ubuntu/distro/firefox.sh
# Installs Firefox from the Mozilla Team PPA for Ubuntu.
# Sets pin priority so the PPA version is preferred over the snap version.
# Called by gui.sh via: bash <(curl ... firefox.sh)
# =============================================================================
